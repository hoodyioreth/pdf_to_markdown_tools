...
def main():
    ...
    flowchart = ["Extract Text", "Detect Headings", "Convert to Markdown"]
    ...
    print("\n📦 Summary:")
    print(f"   • Extracted text → {pdf_basename}.txt")
    print(f"   • Headings JSON → {pdf_basename}.headings.json")
    print(f"   • Final Markdown → {pdf_basename}.md")
